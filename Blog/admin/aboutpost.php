...
if ($stmt = $con->prepare("UPDATE about SET title = ?, body = ?
WHERE id=?"))
{
...
if($stmt = $con->prepare("SELECT * FROM about WHERE id=?"))
{
...
// if the 'id' value is not valid, redirect the user back to the about.php page
else
{
header("Location: about.php");
}
...
if ($stmt = $con->prepare("INSERT about (title, body) VALUES (?, ?)"))
{
